...
Note: OpenAI configuration has been removed to eliminate paid API costs.
...
class Config:
    ...
    # ============================================
    # Fallback Providers (Priority Order - ALL FREE)
    # ============================================
...
ติดต่อ Admin เพื่อขอความช่วยเหลือ"""
    ...
    def get_available_providers(self) -> List[str]:
        """Get list of configured providers (ALL FREE)"""
        providers = []
